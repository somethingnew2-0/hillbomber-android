...
public class GoogleParser {
    ...
    public String directions(final GeoPoint start, final GeoPoint dest) {
        String jsonURL = "http://maps.google.com/maps/api/directions/json?";
        final StringBuffer buffer = new StringBuffer(jsonURL);
        buffer.append("origin=");
        buffer.append(start.getLatitudeE6()/1E6);
        buffer.append(',');
        buffer.append(start.getLongitudeE6()/1E6);
        buffer.append("&destination=");
        buffer.append(dest.getLatitudeE6()/1E6);
        buffer.append(',');
        buffer.append(dest.getLongitudeE6()/1E6);
        buffer.append("&sensor=true&mode=driving");
